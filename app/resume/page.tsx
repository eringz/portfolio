...
const about = {
    ...
    info: [
        ...
        {
            fieldName: 'Freelance',
            fieldValue: 'English, Tagalog, 한국어, 日本語, Spanish'
        },
    ]
}
...
const education = {
    ...
    title: 'My Education',
    description: 'Holds a Bachelor of Science in Computer Engineering and has studied Automobile Mechanics, complemented by extensive training in web development, providing me with a diverse skill set and a strong foundation in technical and practical applications.',
    items: [
        {
        ...
        },
        {
            ...
            degree: 'TESDA Training Platform',
